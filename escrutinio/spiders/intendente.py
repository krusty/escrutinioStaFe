...
class IntendenteSpider(scrapy.Spider):
    name = 'intendente'

    allowed_domains = ['elecciones.santafe.gov.ar']
    #rosario
    #urls = ['https://elecciones.santafe.gov.ar/mesa/intendente/%s/N' %
            #(i) for i in range(3687, 6343)]
    #extranjeros rosario
    #urls = ['https://elecciones.santafe.gov.ar/mesa/intendente/%s/E' %
            #(i) for i in range(8000, 8051)]
    #pueblo esther
    urls = ['https://elecciones.santafe.gov.ar/mesa/intendente/%s/N' %
